...
// ---------------------------------------------------------------------------
  ...
  const CONTENT_I18N = {
    vi: {
      ...
      phish_block: "ScholarFlow cảnh báo Phishing: phát hiện mẫu ({0})",
      phish_typo: "ScholarFlow: có thể là typo-squat '{0}' giống '{1}' — hãy kiểm tra URL cẩn thận.",
      phish_puny: "ScholarFlow: tên miền punycode '{0}' — có thể là tấn công ký tự giả mạo (homograph).",
    ...
    en: {
      ...
      phish_block: "ScholarFlow Phishing Alert: phishing pattern ({0})",
      phish_typo: "ScholarFlow: possible typo-squat '{0}' looks like '{1}' — check the URL carefully.",
      phish_puny: "ScholarFlow: punycode host '{0}' — possible homograph attack.",
    ...
    zh: {
      ...
      style_pixelate: "马赛克",
      style_hide: "隐藏元素",
      phish_block: "ScholarFlow 钓鱼警告：检测到钓鱼特征 ({0})",
      phish_typo: "ScholarFlow：可能是域名仿冒 '{0}'，与 '{1}' 相似 — 请仔细检查网址。",
      phish_puny: "ScholarFlow：punycode 域名 '{0}' — 可能是同形异义字（homograph）攻击。",
      phish_continue: "继续访问",
      phish_dismiss: "关闭",
      phish_title: "钓鱼警告",
    ...
    ru: {
      ...
      phish_block: "Предупреждение ScholarFlow: обнаружен фишинговый паттерн ({0})",
      phish_typo: "ScholarFlow: возможен typo-squat '{0}' — похож на '{1}'. Проверьте адрес внимательно.",
      phish_puny: "ScholarFlow: punycode-домен '{0}' — возможна атака с подменой символов (homograph).",
    ...
    ja: {
      ...
      style_pixelate: "モザイク",
      style_hide: "要素を非表示",
      phish_block: "ScholarFlow フィッシング警告：不審なパターンを検出 ({0})",
      phish_typo: "ScholarFlow: '{0}' は '{1}' に似た typo-squat の可能性があります — URL をよく確認してください。",
      phish_puny: "ScholarFlow: punycode ホスト '{0}' — 同形異義語（homograph）攻撃の可能性。",
      phish_continue: "続行",
      phish_dismiss: "閉じる",
